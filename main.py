...
def main():
    ...
    print(
        f"\033[0;33m[INFO]\033[0m Downloading video from {args.url} in "
        f"{args.format.upper()} format for {args.duration} seconds..."
    )
    ...
    print(
        f"\033[0;33m[INFO]\033[0m Processing to create a "
    ...
    print(
        ...
        f"{args.format.upper()} created at: {output_path}"
    )
